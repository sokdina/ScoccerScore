...
@WebFilter(urlPatterns = {"/user/*","/player/*", "/game/*", "/goal/*"})
public class ProtectFilter implements Filter {
    ...
    private void response401(HttpServletResponse response) throws IOException {
        ...
        response.setHeader("WWW-Authenticate", "Basic realm=\"Please type your email and password into the SoccerRecords System\"");
        response.getWriter().println("<html><body><h2>401 Unauthorized User for the SoccerRecords System!</h2> Please check your email and password ... <br> Or contract PA165 ...</body></html>");
    }
