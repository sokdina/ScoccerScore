            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><my:a href="/team/list"><f:message key="navigation.admin.team"/></my:a></li>
                        <li><my:a href="/player/list"><f:message key="navigation.admin.player"/></my:a></li>
                        <li><my:a href="/game/list"><f:message key="navigation.admin.game"/></my:a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="https://github.com/sokdina/SoccerRecords">Github Repository</a></li>
			<li><a href="https://github.com/sokdina/SoccerRecords/wiki">Project Wiki</a></li>
                    </ul>
                </li>
                <li class="dropdown">
